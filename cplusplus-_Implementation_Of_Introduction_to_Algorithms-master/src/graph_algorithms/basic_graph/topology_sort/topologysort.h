...
namespace IntroductionToAlgorithm
{
    namespace GraphAlgorithm
    {
        ...
        *
        */
        template<typename GraphType> std::vector<typename GraphType::VIDType> 
        topology_sort(std::shared_ptr<GraphType> graph)
        {
            ...
            ActionType finish_action = [&sorted_result](VIDType v_id,int time)                      //进行深度搜索
                {sorted_result.insert(sorted_result.begin(),v_id);};
