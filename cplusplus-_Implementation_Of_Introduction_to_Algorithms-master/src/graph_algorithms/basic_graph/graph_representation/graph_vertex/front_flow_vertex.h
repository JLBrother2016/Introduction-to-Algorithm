    ...
    namespace GraphAlgorithm
    {
        ...
        */
        ...
        struct List
        {
            ...
            *
            */
            List() : head(std::shared_ptr<NodeType>()), 
                     current(std::shared_ptr<NodeType>()){}
            ...
            */
            ...
            front_of(std::shared_ptr<NodeType> element) const
            {
                if(!element)
        ...
        */
        ...
        struct FrontFlowVertex : public FlowVertex<KType>
        {
